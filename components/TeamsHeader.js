...
export const TeamsHeader = ({ 
  ...
  const styles = StyleSheet.create({
    container: {
      ...
      paddingHorizontal: vertical ? SPACING.xxs : SPACING.md,
      paddingVertical: vertical ? SPACING.xxs : SPACING.xs,
      width: vertical ? '100%' : '100%',
      height: vertical ? '100%' : 'auto',
      gap: vertical ? SPACING.xxs : SPACING.xs,
    },
    ...
    teamsScroll: {
      flexDirection: vertical ? 'column' : 'row',
      alignItems: 'center',
      gap: vertical ? SPACING.xxs : SPACING.xxs,
      paddingVertical: vertical ? SPACING.xxs : 2,
      paddingHorizontal: 0,
    },
    teamCard: {
      minWidth: vertical ? '100%' : 85,
      minHeight: vertical ? 36 : 60,
      borderRadius: 10,
      overflow: 'hidden',
      elevation: 2,
      shadowColor: '#000',
      ...
      shadowRadius: 1.5,
      borderWidth: 1.5,
      marginBottom: vertical ? 1.5 : 0,
    },
    teamCardContent: {
      paddingVertical: vertical ? 2 : SPACING.xxs,
      paddingHorizontal: vertical ? SPACING.xxs : SPACING.xs,
      alignItems: 'center',
    ...
    actionButton: {
      ...
      paddingHorizontal: vertical ? SPACING.xxs : 6,
      borderRadius: 5,
      overflow: 'hidden',
      alignItems: 'center',
      justifyContent: 'center',
      minHeight: vertical ? 24 : 34,
      minWidth: vertical ? 40 : 34,
      elevation: 1,
      shadowColor: '#000',
          ...
          return (
            ...
            >
              ...
              >
                ...
                <View style={{ flexDirection: 'row', justifyContent: 'center', gap: 4, marginTop: 1 }}>
                  <TouchableOpacity
                    style={{
                      width: 14,
                      height: 14,
